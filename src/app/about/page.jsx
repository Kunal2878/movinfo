...
const Page = () => {
    return (
      <div className=' bg-black w-full flex-col font-extrabold p-2'>
          <div className="w-full flex  justify-center " style={{fontFamily:'Neon Energy X'}}><span className="ml-3 text-xl bg-gradient-to-r from-green-800 to-red-600 bg-clip-text text-transparent ">MOVFLIX</span></div>
             <p className="bg-clip-text text-transparent bg-gradient-to-b from-pink-500 via-red-500 to-yellow-500 p-4">Welcome to "MovFlix Hub" – your ultimate destination for a diverse cinematic experience! Immerse yourself in a world of entertainment that transcends borders, featuring a rich collection of foreign movies, Indian cinema, captivating animes, and mesmerizing mangas. At MovFlix Hub, we curate a vast selection of films and series across four distinct genres: Most Popular, Action, Comedy, and Sci-fi, ensuring there's something for every taste.
