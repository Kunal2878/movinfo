...
const Page = () => {
    return (
      <div className=' bg-black w-full flex-col font-extrabold p-2'>
          <div className="w-full flex  justify-center " style={{fontFamily: "Neon Energy X"}}
><span className={"ml-3 text-xl bg-gradient-to-r from-green-800 to-red-600 bg-clip-text text-transparent "}
>MOVFLIX</span></div>
